...
// registering scroll-trigger animations of GSAP
...
const Hero = () => {
	...
	const upComingVideoIndex = (currentIndex % totalVideos) + 1; //circular rendering/indexing
	...
	return (
		<div id="hero" className="relative h-dvh w-screen overflow-x-hidden">
			...
			<div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
				...
				<div className="absolute left-0 top-0 z-40 size-full">
					<div className="mt-24 px-5 sm:px-10">
						<h1 className="special-font hero-heading text-blue-100">A2Z<b>Health</b>Care</h1>
			...
			{/* For animated scrolling after effect where black & white header will appear half & half on scrolling */}
