...
const OurMission = () => {
  return (
    ...
    >
      ...
      <motion.div
        className="flex flex-col gap-4 bg-[#F3FFDE] p-12 rounded-r-2xl w-1/2"
        initial={{ opacity: 0, x: 50 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5 }}
        viewport={{ once: true }}
      >
        ...
        <button className="text-[16px] font-[600] mt-6 py-3 px-6 rounded-full bg-white text-black w-fit">
          View all Services
        </button>
      </motion.div>
    </motion.div>
